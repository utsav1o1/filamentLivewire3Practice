            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a href="{{route('AboutUs')}}">About</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7">
                    <div class="section-title">
                        ...
                        <h2 class="h1 mb-4">{{$aboutus->title}}</h2>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <img loading="lazy" decoding="async" src="{{asset('storage/'.$aboutus->img)}}" alt="Business Loans &lt;br&gt; For Daily Expenses" class="rounded w-100">
                </div>
            </div>
        </div>
    </section>
