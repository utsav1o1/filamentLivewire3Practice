                                ...
                                <div class="contact-form">
                                    <form wire:submit='submit'>
                                        <div class="form-group mb-4 pb-2">
                                            ...
                                            <input wire:model='name' type="text" class="form-control shadow-none" id="contact_name" required>
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            <label for="email" class="form-label">Email address</label>
                                            <input wire:model='email' type="email" class="form-control shadow-none" id="contact_email" required>
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            <label for="message" class="form-label">Write Message</label>
                                            <textarea wire:model='message' class="form-control shadow-none" id="exampleFormControlTextarea1" rows="3" required></textarea>
                                        </div>
