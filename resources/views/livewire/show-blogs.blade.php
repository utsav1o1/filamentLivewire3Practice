                                    ...
                                    <article class="blog-post">
                                        <div class="post-slider slider-sm rounded">
                                            <img loading="lazy" decoding="async"
                                                src="{{ asset('storage/' . $blog->imgUrl) }}" alt="Post Thumbnail">
                                        ...
                                        <div class="pt-4">
                                            ...
                                            <h2 class="h4">
                                                <bc wire:navigate  class="text-black" href="{{ route('BlogDetail',$blog->id) }}">
                                                    {{ $blog->title }}</bc>
                                            </h2>
                                            <p>{{ $blog->short_desc }} …</p> <a wire:navigate
                                                href="{{ route('BlogDetail',$blog->id) }}" class="text-primary fw-bold"
                    ...
                    <div class="widget widget-categories">
                        ...
                        <ul class="list-unstyled widget-list">
                            @foreach ($categories as $category)
                                ...
                                <li><a href="{{ route('Blog') . '?categorySlug=' . $category->slug }}">{{ $category->name }}<small
                                            class="ml-auto">
                                            @foreach ($blogs as $blog)
                                ...
                                <li class="d-flex widget-post align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="h6 mb-0"><a class="text-black"
                                                href="{{ route('BlogDetail', $blog->id) }}">{{ $blog->title }}</a></h5>
