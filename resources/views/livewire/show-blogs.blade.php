                        ...
                        <div class="row gy-5">
                            ...
                            <div class="col-md-6" data-aos="fade">
                                <article class="blog-post">
                                    ...
                                    <div class="pt-4">
                                        <p class="mb-3">{{ $blog->created_at->format('Y-m-d') }}</p>
                                        <h2 class="h4"><bc class="text-black" href="{{route('BlogDetail',$blog->id)}}">{{$blog->title}}</bc></h2>
                                        <p>{{ $blog->short_desc }} …</p> <a href="{{route('BlogDetail',$blog->id)}}" class="text-primary fw-bold" aria-label="Read the full article by clicking here">Read More</a>
                                    </div>
                                </article>
                            </div>
                            @endforeach
                ...
                <div class="col-lg-3">
                    ...
                    <div class="widget widget-categories">
                        ...
                        <ul class="list-unstyled widget-list">	
                            ...
                            <li><a href="#!">{{$category->name}}<small class="ml-auto">
                            @foreach ($blogs as $blog )
                                @if ($blog->categories_id == $category->id )
                                   @php
                                      $x++ ;
                                   @endphp
                                @endif
                    ...
                    <div class="widget">
                        ...
                        <ul class="list-unstyled widget-list">
                            <li class="d-flex widget-post align-items-center">
                                <a class="text-black" href="{{route('BlogDetail',$blog->id)}}">
                                    <div class="widget-post-image flex-shrink-0 me-3">
                                        <img class="rounded" loading="lazy" decoding="async" src="{{asset('storage/'. $blog->imgUrl)}}" alt="Post Thumbnail">
                                    </div>
                                </a>
                                <div class="flex-grow-1">
                                    <h5 class="h6 mb-0"><a class="text-black" href="blog-details.html">{{$blog->title}}</a></h5>
